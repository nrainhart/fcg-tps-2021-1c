...
$(document).ready(function() 
{
	...
	// Las elegí para que abarquen el área de la pantalla, pero se pueden cambiar a gusto
	...
	{
		// Si hay un círculo seleccionado...
		if ( selPt ) 
		{
...
function UpdateLines()
{
	...
	// Vamos a obtenerlos y a actualizar sus coordenadas de inicio y fin
...
// Configuración del tamaño del canvas, se ejecuta al inicializar
...
function DrawScene()
{
	// Limpiamos la pantalla (y el buffer de profundidad, algo que no estamos usando
...
class LineDrawer 
{
	...
	constructor()
	{
		...
		// Obtenemos la ubicación de las variables uniformes en los shaders,
	...
	{		
		...
		// al ancho y alto del canvas, invirtiendo la coordenada y. La matriz está en formato
		// column-major.
